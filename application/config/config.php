...
//$config['base_url'] = 'http://192.168.1.6/punto_de_venta/index.php';	// cambiar aqui jm
 $config['base_url'] = 'http://localhost/SysConta/index.php';
...
|--------------------------------------------------------------------------
|
| Typically this will be your boletas.php file, unless you've renamed it to
...
| example.com/boletas.php?c=controller&m=function
|
